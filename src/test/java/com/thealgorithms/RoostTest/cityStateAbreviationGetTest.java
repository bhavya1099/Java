...
public class cityStateAbreviationGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {"stateAbreviation", "BASE_URL"};
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/city_stateAbreviationGetTest.csv", envVarsList);
    }

  
    @Test  
    public void cityStateAbreviationGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: cityStateAbreviationGet_Test \n", testNumber++);
              System.out.println("Request: GET /city/{stateAbreviation}");
