...
public class complementTypesGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/complementTypesGetTest.csv", envVarsList);
    }
    ...
    public void complementTypesGet_Test() throws JSONException {
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: complementTypesGet_Test \n", testNumber++);
              System.out.println("Request: GET /complementTypes");
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (response.get("complements") != null) {
                        
                  for (int i = 0; i < response.getList("complements").size(); i++) {      
              if (response.get("complements["+ i +"].type") != null) {
                  
                MatcherAssert.assertThat(response.get("complements["+ i +"].type"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("complements["+ i +"].type").length(), lessThanOrEqualTo(2));

              }
      
              if (response.get("complements["+ i +"].description") != null) {
                  
                MatcherAssert.assertThat(response.get("complements["+ i +"].description"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("complements["+ i +"].description").length(), lessThanOrEqualTo(50));

              }
        
                    }    
                MatcherAssert.assertThat(response.getList("complements"), instanceOf(List.class));
