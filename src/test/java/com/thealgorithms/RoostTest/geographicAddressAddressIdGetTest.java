...
public class geographicAddressAddressIdGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/geographicAddress_addressIdGetTest.csv", envVarsList);
    }

  
    @Test  
    public void geographicAddressAddressIdGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
                ...
                .when()
                .get("/geographicAddress/{addressId}")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: geographicAddressAddressIdGet_Test \n", testNumber++);
              System.out.println("Request: GET /geographicAddress/{addressId}");
