...
Test generated for /geographicAddress_get for http method type GET in rest-assured framework

RoostTestHash=6f2c4d8b1a
...
public class geographicAddressGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/geographicAddressGetTest.csv", envVarsList);
    }

  
    @Test  
    public void geographicAddressGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.queryParam("address", testData.get("address") != null ? testData.get("address") : "")
              ...
              System.out.printf("Test Case %d: geographicAddressGet_Test \n", testNumber++);
              System.out.println("Request: GET /geographicAddress");
      ...
      List<Integer> expectedStatusCodes = Arrays.asList(200,400,403,404,429,500,503,504);
