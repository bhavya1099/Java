...
public class kafkaV3ClustersClusterIdTopicsGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/kafka_v3_clusters_cluster_id_topicsGetTest.csv", envVarsList);
    }
          ...
          case '5':
            ...
            break;
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if(stringifiedStatusCode.equals("200")){					System.out.println("Description: The list of topics.");
				}
