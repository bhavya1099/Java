...
Test generated for /kafka/v3/clusters/{cluster_id}/topics/{topic_name}_delete for http method type DELETE in rest-assured framework

RoostTestHash=bcf2d73ce2
...
public class kafkaV3ClustersClusterIdTopicsTopicNameDeleteTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/kafka_v3_clusters_cluster_id_topics_topic_nameDeleteTest.csv", envVarsList);
    }

  
    @Test  
    public void kafkaV3ClustersClusterIdTopicsTopicNameDelete_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: kafkaV3ClustersClusterIdTopicsTopicNameDelete_Test \n", testNumber++);
              System.out.println("Request: DELETE /kafka/v3/clusters/{cluster_id}/topics/{topic_name}");
      ...
      List<Integer> expectedStatusCodes = Arrays.asList(204,400,401,403,404,429);
          ...
          case '5':
            ...
            break;
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if(stringifiedStatusCode.equals("204")){					System.out.println("Description: No Content");
				}
