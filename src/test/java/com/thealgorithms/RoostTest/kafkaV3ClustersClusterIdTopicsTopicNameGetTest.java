...
Test generated for /kafka/v3/clusters/{cluster_id}/topics/{topic_name}_get for http method type GET in rest-assured framework

RoostTestHash=28102fa8be
...
public class kafkaV3ClustersClusterIdTopicsTopicNameGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/kafka_v3_clusters_cluster_id_topics_topic_nameGetTest.csv", envVarsList);
    }

  
    @Test  
    public void kafkaV3ClustersClusterIdTopicsTopicNameGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.queryParam("include_authorized_operations", testData.get("include_authorized_operations") != null ? testData.get("include_authorized_operations") : "")
              ...
              System.out.printf("Test Case %d: kafkaV3ClustersClusterIdTopicsTopicNameGet_Test \n", testNumber++);
              System.out.println("Request: GET /kafka/v3/clusters/{cluster_id}/topics/{topic_name}");
          ...
          case '5':
            ...
            break;
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if(stringifiedStatusCode.equals("200")){					System.out.println("Description: The topic.");
				}
