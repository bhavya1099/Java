...
Test generated for /kafka/v3/clusters/{cluster_id}/topics/{topic_name}/partitions_get for http method type GET in rest-assured framework

RoostTestHash=7400d19c15
...
public class kafkaV3ClustersClusterIdTopicsTopicNamePartitionsGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/kafka_v3_clusters_cluster_id_topics_topic_name_partitionsGetTest.csv", envVarsList);
    }

  
    @Test  
    public void kafkaV3ClustersClusterIdTopicsTopicNamePartitionsGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: kafkaV3ClustersClusterIdTopicsTopicNamePartitionsGet_Test \n", testNumber++);
              System.out.println("Request: GET /kafka/v3/clusters/{cluster_id}/topics/{topic_name}/partitions");
          ...
          case '5':
            ...
            break;
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if(stringifiedStatusCode.equals("200")){					System.out.println("Description: The list of partitions.");
				}
