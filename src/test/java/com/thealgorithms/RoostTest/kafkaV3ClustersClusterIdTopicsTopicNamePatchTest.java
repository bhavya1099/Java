...
Test generated for /kafka/v3/clusters/{cluster_id}/topics/{topic_name}_patch for http method type PATCH in rest-assured framework

RoostTestHash=bde20c3f25
...
public class kafkaV3ClustersClusterIdTopicsTopicNamePatchTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/kafka_v3_clusters_cluster_id_topics_topic_namePatchTest.csv", envVarsList);
    }

  
    @Test  
    public void kafkaV3ClustersClusterIdTopicsTopicNamePatch_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: kafkaV3ClustersClusterIdTopicsTopicNamePatch_Test \n", testNumber++);
              System.out.println("Request: PATCH /kafka/v3/clusters/{cluster_id}/topics/{topic_name}");
      ...
      List<Integer> expectedStatusCodes = Arrays.asList(200,400,401,403,429);
