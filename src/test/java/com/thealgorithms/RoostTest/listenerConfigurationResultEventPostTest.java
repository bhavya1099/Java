...
Test generated for /listener/configurationResultEvent_post for http method type POST in rest-assured framework

RoostTestHash=af38304a1d
...
public class listenerConfigurationResultEventPostTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {"iuop_BASE_URL"};
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/listener_configurationResultEventPostTest.csv", envVarsList);
    }

  
    @Test  
    public void listenerConfigurationResultEventPost_Test() throws JSONException {
        this.setUp();
        Integer testNumber = 1;
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("iuop_BASE_URL") != null && !testData.get("iuop_BASE_URL").isEmpty()) ? testData.get("iuop_BASE_URL"): testData.get("iuop_BASE_URL");  
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
                ...
                .when()
                .post("/listener/configurationResultEvent")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: listenerConfigurationResultEventPost_Test \n", testNumber++);
              System.out.println("Request: POST /listener/configurationResultEvent");
