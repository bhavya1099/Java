...
Test generated for /listener/serviceTestResultEvent_post for http method type POST in rest-assured framework

RoostTestHash=b37ddd4bea
...
public class listenerServiceTestResultEventPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/listener_serviceTestResultEventPostTest.csv", envVarsList);
    }

  
    @Test  
    public void listenerServiceTestResultEventPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
                ...
                .when()
                .post("/listener/serviceTestResultEvent")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: listenerServiceTestResultEventPost_Test \n", testNumber++);
              System.out.println("Request: POST /listener/serviceTestResultEvent");
