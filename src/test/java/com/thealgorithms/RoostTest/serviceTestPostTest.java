...
Test generated for /serviceTest_post for http method type POST in rest-assured framework

RoostTestHash=b4ca2edfa6
...
public class serviceTestPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/thealgorithms/RoostTest/serviceTestPostTest.csv", envVarsList);
    }

  
    @Test  
    public void serviceTestPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: serviceTestPost_Test \n", testNumber++);
              System.out.println("Request: POST /serviceTest");
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (response.get("control.code") != null) {
                ...
                MatcherAssert.assertThat(response.getString("control.code").length(), lessThanOrEqualTo(10));
...
if(stringifiedStatusCode.equals("400")){					System.out.println("Description: Bad Request");
              ...
              if (response.get("code") != null) {
                ...
                MatcherAssert.assertThat(response.getString("code").length(), lessThanOrEqualTo(10));
