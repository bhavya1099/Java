...
public class ActivitySelectionActivitySelectionTest {
	...
	public void testWithValidInputAndMultipleCompatibleActivities() {
		int[] startTimes = new int[] { 1, 2, 3, 4, 0 };
		int[] endTimes = new int[] { 2, 3, 4, 5, 6 };
		assertEquals(Arrays.asList(0, 4), ActivitySelection.activitySelection(startTimes, endTimes));
	}

	@Test
	public void testWithValidInputAndNoCompatibleActivities() {
		int[] startTimes = new int[] { 1, 2, 3, 4, 5 };
		int[] endTimes = new int[] { 6, 7, 8, 9, 10 };
		assertEquals(Arrays.asList(0), ActivitySelection.activitySelection(startTimes, endTimes));
	}
	...
	public void testWithEmptyInput() {
		...
		assertEquals(new ArrayList<>(), ActivitySelection.activitySelection(startTimes, endTimes));
	}

	@Test
	public void testWithNonMatchingLengths() {
		int[] startTimes = new int[] { 1, 2, 3, 4 };
		int[] endTimes = new int[] { 2, 3, 4, 5, 6 };
	...
	public void testWithOverlappingActivities() {
		...
		assertEquals(Arrays.asList(0, 1, 3, 4), ActivitySelection.activitySelection(startTimes, endTimes));
	}
