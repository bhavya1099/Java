...
public class CoinChangeCoinChangeProblemTest {
	...
	public void testChangeLargeAmount() {
		...
		// Assert
		Assertions.assertEquals(4650, result.stream().mapToInt(Integer::intValue).sum());
		Assertions.assertArrayEquals(new Integer[] { 2000, 2000, 500, 100, 50 }, result.subList(0, 5).toArray());
	}
	...
	public void testChangeSmallAmount() {
		...
		ArrayList<Integer> result = CoinChange.coinChangeProblem(amount);
		// Assert
		Assertions.assertEquals(3, result.stream().mapToInt(Integer::intValue).sum());
		Assertions.assertArrayEquals(new Integer[] { 2, 1 }, result.toArray());
	}
