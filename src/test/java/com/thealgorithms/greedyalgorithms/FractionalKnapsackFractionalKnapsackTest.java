...
import com.thealgorithms.greedyalgorithms.FractionalKnapsack;
...
public class FractionalKnapsackTest {
	...
	public void testAllItemsFitInTheKnapsack() {
		...
		int[] value = { 6, 9, 15 };
		int capacity = 10;
		assertEquals(30, FractionalKnapsack.fractionalKnapsack(weight, value, capacity));
	}
	...
	public void testSomeItemsCannotFitInTheKnapsack() {
		...
		int[] value = { 6, 9, 18 };
		int capacity = 8;
		assertEquals(24, FractionalKnapsack.fractionalKnapsack(weight, value, capacity));
	}
	...
	public void testEqualValueToWeightRatioOfAllItems() {
		...
		int[] value = { 6, 9, 12 };
		int capacity = 5;
		assertEquals(15, FractionalKnapsack.fractionalKnapsack(weight, value, capacity));
	}
