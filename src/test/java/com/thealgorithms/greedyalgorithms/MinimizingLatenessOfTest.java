...
public class MinimizingLatenessOfTest {
	...
	@Test
	@DisplayName("Creating job object with valid arguments")
	void createJobWithValidArgs() {
		// Arrange
		String jobName = "Job1";
	...
	@Test
	@DisplayName("Creating job object with null job name")
	...
	@Test
	@DisplayName("Invalid negative processing time")
	...
	@Test
	@DisplayName("Deadline less than processing time")
	void createTimeLessThanProcessingTime() {
		// Arrange
		String jobName = "Job3";
