...
public class MinimizingLatenessToStringTest {
	...
	public void testTypicalValuesToString() {
		...
		job.jobName = "Job1";
		job.startTime = 5;
		job.processingTime = 5;
		job.lateness = 0;
		// Act
		String result = job.toString();
		// Assert
		assertEquals("Job1, startTime: 5, endTime: 10, lateness: 0", result);
	}
	...
	public void testLatenessToString() {
		...
		String result = job.toString();
		// Assert
		assertEquals("Job1, startTime: 5, endTime: 10, lateness: 15", result);
	}
	...
	public void testNegativeLatenessToString() {
		...
		String result = job.toString();
		// Assert
		assertEquals("Job1, startTime: 10, endTime: 20, lateness: -5", result);
	}
